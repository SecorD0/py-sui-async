...
async def main():
    test = Test()
    await test.balance('0xc4173a804406a365e69dfb297d4eaaf002546ebd')
    await test.generate_wallet()
    await test.request_sui_coins()
    await test.my_balance()
    await test.mint_example_nft()
    await test.mint_wizard_nft()
    await test.mint_bluemove_nft()
    await test.send_coin()
    await test.send_token('usdt')
    await test.send_nft('0x1c47664b9b12fca8ede96726b6d90c854ae512a7')
    await test.merge_coin()
    await test.merge_token('usdt')
    await test.history()
    await test.history('0x0f2df809112256ec9068c2663bc4901c8a1b3ce7')
